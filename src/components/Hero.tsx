  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-24">
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        <p className="mx-auto mb-4 max-w-2xl text-xl text-slate-300">{profile.title}</p>
        <p className="mx-auto mb-10 flex max-w-md items-center justify-center gap-2 text-sm text-slate-400">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-white/15 px-6 py-3 text-sm font-semibold text-slate-200 transition hover:border-sky-400/50 hover:text-sky-400"
          >
            <GitHubIcon size={16} />
            GitHub
          </a>
